...
public class e3_15 {
    public static void main(String[] args) {
        ...
        if (guess == lottery)
            ...
            System.out.println("Match all digits: you win $3,000");
        else if (guessDigit3 == lotteryDigit3 && guessDigit2 == lotteryDigit1 && guessDigit1 == lotteryDigit2)
            System.out.println("Match all digits: you win $3,000");
        else if (guessDigit1 == lotteryDigit2 && guessDigit2 == lotteryDigit3 && guessDigit3 == lotteryDigit1)
            System.out.println("Match all digits: you win $3,000");
        else if (guessDigit3 == lotteryDigit2 && guessDigit2 == lotteryDigit1 && guessDigit1 == lotteryDigit3)
            System.out.println("Match all digits: you win $3,000");
